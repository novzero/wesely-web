...
$.getJSON(
  ...
  function (result) {
    ...
    if (weather === "Rain" || weather === 'Drizzle' || weather === 'Thunderstorm') {
      ...
      $('.sm1').append('<b>비가 내리는 날씨! <br />실내에서 운동할까요?</b>');
      ...
      $('.sm1').append('<b>선선한 날씨! <br />야외활동은 어떠세요?</b>');
      let keyframes = [
      ...
      document.querySelector('.inAct img:last-child').animate(keyframes1, options1);
      ...
      $('.inAct').append('<img class="backGround" src="/images/backGround.png">');
      $('.window').append('<img class="cloud" src="/images/cloud.png">');
      $('.sm1').append('<b>흐린 날씨! <br />차분한 실내운동은 어떠세요?</b>');
      ...
      $('.window').attr('style', 'display: none;');
      $('.sm1').append('<b>화창한 날씨! <br />야외활동은 어떠세요?</b>');
